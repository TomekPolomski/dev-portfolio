...
const Footer = () => {
	return (
		<footer className='relative py-8 max-w-[1200px] mx-auto px-4 overflow-hidden'>
			...
			<div className='grid grid-cols-2 sm:grid-cols-3 gap-8 text-gray-200 relative z-10'>
			...
			<div className='text-gray-400 mt-12 container flex sm:justify-between justify-center items-center gap-10 relative z-10'>
				...
				<ul className='flex flex-row gap-6'>
					<li>
						<a href='#'>
							<AiFillGithub
								size={30}
								className='hover:fill-purple-500 transition-colors duration-300'
							/>
						</a>
					</li>
					<li>
